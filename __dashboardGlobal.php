    ...
    <div class="col-md-2">&nbsp;</div>
        <div class="col-md-8">
          ...
          <ul class="nav nav-pills" style="position:relative;left:-60px;">
            ...
            <li style="background-color:rgb(238,238,238);-moz-border-radius: 4px;-webkit-border-radius: 4px;border-radius: 4px; -khtml-border-radius: 4px;"><a href="online/assesment_jobGlobal.php">Under Assessment</a></li>
            <li style="background-color:rgb(238,238,238);-moz-border-radius: 4px;-webkit-border-radius: 4px;border-radius: 4px; -khtml-border-radius: 4px;"><a href="online/collection_jobGlobal.php">Ready for Collection</a></li>
            <li style="background-color:rgb(238,238,238);-moz-border-radius: 4px;-webkit-border-radius: 4px;border-radius: 4px; -khtml-border-radius: 4px;"><a href="online/closedJobsGlobal.php">Accepted and Rejected Jobs</a></li>
            <li style="background-color:rgb(238,238,238);-moz-border-radius: 4px;-webkit-border-radius: 4px;border-radius: 4px; -khtml-border-radius: 4px;"><a href="online/current_jobGlobal.php">Quoted Jobs</a></li>
          </ul>
        ...
        <div class="col-md-2">
          ...
          <div class="pull-right">
            <a href="online/logout.php"><button type="button" class="btn btn-success">Logout&nbsp;<?php echo $_SESSION['name'] ?></button></a>
            
            <?php if (isset($_SESSION['adminId'])) { ?>
            <br><br><a href="online/admin_page.php"><button type="button" class="btn btn-success">Back to Admin</button></a>
            <?php } ?>
          </div>
      ...
      <div class="row">
		...
		$row = $data[0];
        $desc = $row['fullName'];
        //$query = "SELECT * FROM users u INNER JOIN jobinfoweb j ON (u.customer = j.customer) WHERE u.userId = '" . $_SESSION['adminId'] . "' ";
  ...
  <table class="table table-striped table-condensed table-hover">
	...
	$delivery_address       = $row['DeliveryAddress'];
		$workshop       = $row['Workshop'];
          ...
          echo "<tr>";
          $counter = $j + $no_start;
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $counter . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_account_no . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_account_name . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_jobno . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_quote_date . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_quote_make . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_quote_model . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_quote_serial . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_quote_amount . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_quote_status . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_quote_store_ref . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>" . $job_quote_vendor_ref . "</a></td>";
          echo "<td><a href='online/quote.php?qid=" . $job_jobno . "'>Details</a></td>";
