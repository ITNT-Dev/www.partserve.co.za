...
if ( isset($_POST['orderNum']) ){
	...
	$sql= "select * from JobPurchaseOrders where Job = '".$_GET['Job']."' ";
    ...
    if (!isset($_FILES['orderFile']) || !isset($_FILES['orderFile']['name'])) {
        ...
        try {
            ...
            if (!move_uploaded_file($_FILES['orderFile']['tmp_name'], $filename)) {
				...
				$sql= "insert into $table values('null','".$_GET['Job']."','".$filename."','".date('Y-m-d H:i:s')."',0,'0000-00-00 00:00:00')";
				$conn->query($sql);
