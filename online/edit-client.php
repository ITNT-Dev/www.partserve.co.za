...
if(isset($_GET['id'])){
	...
	list($affect_rows, $datad) = $db->selectquerys($sql);
		foreach ($datad as $row)
      {
		...
		$publish = "<a href='edit-client.php?publish=".$_GET['id']."'>Publish client Info</a>";
	}
...
if(isset($_GET['publish'])){
		...
		$reverse_info = "<a href='edit-client.php?view=".$_SESSION['revert']."'>Revert to intial info</a>";
	}
									...
									<div class="form-group">
				                        ...
				                        <div class="col-sm-10">
				                            <div class="input-group">
				                                ...
				                                <input name="date_reminder" class="form-control" id="date_reminder" placeholder="2017-04-14" value="" type="text">
											</div>
				                        </div>
				                   </div>
								   
				                    <input name="source" class="form-control" id="source" placeholder="Date" value="system" type="hidden">
				                    <!--<div class="form-group">
			...
			<input type="text" class="form-control" name="country" id="country" required autocomplete="off"  <?php
						...
						<div class="form-group">
				                    ...
				                    <div class="form-group">
				                        ...
				                        <div class="col-sm-10">
				                            <input name="quantity" class="form-control" id="quantity" placeholder="Quantity" type="text" <?php
											/*
										if(isset($publish_item))
										{
											echo "value='".$publish_item[20]."'"; 
										}
										*/
										if(isset($view_mine))
										{
