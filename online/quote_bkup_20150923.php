...
<html lang="en">
  <head>
    ...
    <link href="../css/style-for-expand.css" rel="stylesheet">
        ...
        ?>
          ...
          <tr>
            ...
            <tr>
              ...
              ?>
                  <!--&nbsp; <a href="#uploadProofOfPurchase" class="btn btn-warning btn-xs" title="Upload Proof of Purchase">Upload proof of purchase</a>-->
              <?php
              }
              ?>
              ...
              ?>
                  <!--&nbsp; <a href="#uploadPurchaseOrder" class="btn btn-warning btn-xs" title="Download Purchase Order">Upload Purchase Order</a>-->
              <?php
              }
              ?>              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                  <table id="report" width="100%">
                      <tbody>
                        <tr class="odd">
                            <td>+ Click to view the date audit for this job <div class="arrow"></div></td>
            ...
            <tr>
              ...
              <td>
                  <table id="report2" width="100%">
                      <tbody>
                        <tr class="odd">
                            <td>+ Click to view the call history for this job <div class="arrow"></div> </td>
                    ...
                    <td><p><strong>PROOF OF PURCHASE</strong></p></td>
                        <td id="uploadProofOfPurchase">
                            <form method="post" action="" onSubmit="return validateProofOfPurchaseForm(this);" enctype="multipart/form-data">
                                ...
                                <p>&nbsp;</p>
                                <input type="hidden" name="job" value="<?php echo $Job; ?>" />
                                <input type="file" name="proofOfPurchasePdf" id="proofOfPurchasePdf" />  <br> <input type="submit" class="btn btn-primary btn-sm" name="submitProofOfPurchase" value="Upload Proof Of Purchase" /> &nbsp; <em>( *.pdf ) files only</em>
                            </form>
                            <script>
