    ...
    <div class="col-md-2">&nbsp;</div>
        <div class="col-md-8">
          <ul class="nav nav-pills" style="position:relative;left:-60px;">
            ...
            <li class="active"><a href="collection_jobGlobal.php">Ready for Collection</a></li>
...
?>
      ...
      <div class="row">
        ...
        <?php //include "inc_table_collection.php"; ?>
          ...
          if ($_SESSION['accountType'] == 'admin') {
            $query = "SELECT * FROM users u INNER JOIN jobinfoweb j ON (u.customer = j.customer) WHERE u.linkedTo = '" . $_SESSION['adminId'] . "' AND Status='Ready for Collection' ";
          } else {
            $query = "SELECT * FROM users u INNER JOIN jobinfoweb j ON (u.customer = j.customer) WHERE u.userId = '" . $_SESSION['adminId'] . "' AND Status='Ready for Collection' ";
          }
