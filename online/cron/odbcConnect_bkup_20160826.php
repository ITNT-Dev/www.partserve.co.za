...
try {
    mail("gavin@itnt.co.za",'DB Update Cron Started at ' . date('Y-m-d H:i:s'), $_SERVER['SCRIPT_NAME'] . ' @ ' . date('Y-m-d H:i:s'), '');
}
catch (Exception $ex) {
...
try {
    mail("gavin@itnt.co.za",'DB Update Cron Executing JobUpdateCustomer at ' . date('Y-m-d H:i:s'), $_SERVER['SCRIPT_NAME'] . ' @ ' . date('Y-m-d H:i:s'), '');
}
catch (Exception $ex) {
...
try {
    mail("gavin@itnt.co.za",'DB Update Cron Executing writeBack.php at ' . date('Y-m-d H:i:s'), $_SERVER['SCRIPT_NAME'] . ' @ ' . date('Y-m-d H:i:s'), '');
}
catch (Exception $ex) {
