	...
	if(mysql_num_rows($test)>0){
			echo odbc_result($res,"job")."- Job already Exists in database</br>";
					...
					$sql = "UPDATE jobinfoweb 
							SET Customer='".mysql_real_escape_string(trim(odbc_result($res,"Customer")))."',
								 CustomerName='".mysql_real_escape_string(trim(odbc_result($res,"CustomerName")))."',
								 PhysicalAddress1='".mysql_real_escape_string(trim(odbc_result($res,"PhysicalAddress1")))."',
								 PhysicalAddress2='".mysql_real_escape_string(trim(odbc_result($res,"PhysicalAddress2")))."',
								 PhysicalAddress3='".mysql_real_escape_string(trim(odbc_result($res,"PhysicalAddress3")))."',
								 PhysicalAddress4='".mysql_real_escape_string(trim(odbc_result($res,"PhysicalAddress4")))."',
								 PhysicalAddress5='".mysql_real_escape_string(trim(odbc_result($res,"PhysicalAddress5")))."',
								 AccountContactName='".mysql_real_escape_string(trim(odbc_result($res,"AccountContactName")))."',
								 AccountContactEmail='".mysql_real_escape_string(trim(odbc_result($res,"AccountContactEmail")))."',
								 AccountContactTel='".mysql_real_escape_string(trim(odbc_result($res,"AccountContactTel")))."',
								 AccountContactCell='".mysql_real_escape_string(trim(odbc_result($res,"AccountContactCell")))."',
								 SalesContactName='".mysql_real_escape_string(trim(odbc_result($res,"SalesContactName")))."',
								 SalesContactEmail='".mysql_real_escape_string(trim(odbc_result($res,"SalesContactEmail")))."',
								 SalesContactCell='".mysql_real_escape_string(trim(odbc_result($res,"SalesContactCell")))."',
								 SalesContactTel='".mysql_real_escape_string(trim(odbc_result($res,"SalesContactTel")))."',
								 LastContactNotes='".mysql_real_escape_string(trim(odbc_result($res,"LastContactNotes")))."',
								 QuoteAccountNumber='".mysql_real_escape_string(trim(odbc_result($res,"QuoteAccountNumber")))."',
								 QuoteDRRef='".mysql_real_escape_string(trim(odbc_result($res,"QuoteDRRef")))."',
								 QuoteJobDate='".mysql_real_escape_string(trim(odbc_result($res,"QuoteJobDate")))."',
								 QuoteMake='".mysql_real_escape_string(trim(odbc_result($res,"QuoteMake")))."',
								 QuoteModel='".mysql_real_escape_string(trim(odbc_result($res,"QuoteModel"))."',
								 QuoteSerialNumber='".mysql_real_escape_string(trim(odbc_result($res,"QuoteSerialNumber")))."',
								 QuoteActionRequired='".mysql_real_escape_string(trim(odbc_result($res,"QuoteActionRequired")))."',
								 QuoteTotal='".mysql_real_escape_string(trim(odbc_result($res,"QuoteTotal")))."',
								 QuoteDiscountPer='".mysql_real_escape_string(trim(odbc_result($res,"QuoteDiscountPer")))."',
								 QuoteDiscount='".mysql_real_escape_string(trim(odbc_result($res,"QuoteDiscount")))."',
								 QuoteTotalTax='".mysql_real_escape_string(trim(odbc_result($res,"QuoteTotalTax")))."',
								 QuoteGrandTotal='".mysql_real_escape_string(trim(odbc_result($res,"QuoteGrandTotal")))."',
								 FaultDescription='".mysql_real_escape_string(trim(odbc_result($res,"FaultDescription'")))."',
								 Accessories='".mysql_real_escape_string(trim(odbc_result($res,"Accessories")))."',
								 WorkDone='".mysql_real_escape_string(trim(odbc_result($res,"WorkDone")))."',
								 Item= '".mysql_real_escape_string(trim(odbc_result($res,"Item")))."',
								 Status= '".mysql_real_escape_string(trim(odbc_result($res,"Status")))."'
