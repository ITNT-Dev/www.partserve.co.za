...
{
    send_email("gavin@itnt.co.za", "DB update cron", "Cannot establish an odbc connection to Partserv server. <br>".odbc_error());
...
// Sending email
if(send_email($debug ? 'gavin@itnt.co.za' : 'onlinejt@partserve.co.za', 'DB update cron', $message, $debug ? '' : "gavin@itnt.co.za"))
{
